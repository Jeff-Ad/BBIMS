					...
					<div class="col-xs-12 col-sm-12 col-md-11">
						<div class="card card-primary">
							<div class="card-heading">
								<h3 class="card-title text-center" style="padding:5px;font-size:16px;font-weight:bold"><span class="fa fa-envelope "> </span> Blood Request</h3>
							</div>
							<div class="card-body">
								<p id="errorBox"></p>
							...
							<div class="alert alert-danger">
								...
								<div class="form-group">
									<label class="control-label text-primary">Unit Of Blood Needed Volume (L)</label>
									<input type="number" required name="volume" id="BUNIT" class="form-control" placeholder="Volume">
								</div>
